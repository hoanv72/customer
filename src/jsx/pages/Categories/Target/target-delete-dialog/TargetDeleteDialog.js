...
import { deleteList } from '../../Client/_redux/clientSlice';
import { useTargetUIContext } from '../TargetUIContext';
// import * as actions from '../../../_redux/customers/customersActions';
// import { useNotification } from './../../../../../../app/WrapNotification';

export function TargetDeleteDialog({ id, show, onHide, dmsPage }) {
  ...
  const targetUIProps = useMemo(() => {
    return {
      setIds: targetUIContext.setIds,
      queryParams: targetUIContext.queryParams,
    };
  }, [targetUIContext]);
